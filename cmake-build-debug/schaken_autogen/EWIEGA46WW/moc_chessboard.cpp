...
void ChessBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ChessBoard::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChessBoard::clicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ChessBoard::clicked(int _t1, int _t2)
{
